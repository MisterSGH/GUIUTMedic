...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 12-08-2025 a las 07:02:51
...
(14, 4, 4, 11, '2025-12-31', '12:00:00', '', 'Programada'),
(15, 4, 4, 11, '2025-12-31', '12:00:00', '', 'Programada');
...
INSERT INTO `perfil` (`idPerfil`, `idUsuario`, `nombre`, `apellido_paterno`, `apellido_materno`, `telefono`, `contactoEmergencia`, `alergias`, `peso`, `condicionMedica`, `foto`) VALUES
(4, 4, 'Santiago', 'Guzman', 'Hernandez', '1234567890', '9876543210', 'si', NULL, 'Ninguna', 'C:\\Users\\santi\\OneDrive\\Imágenes\\ku89-100x100.png');
...
(1, 'Dra. Ana Torres', 'Médico', 'ana.torres@utmedic.com', '4431234567', 1),
(4, 'Dra. Laura Pérez', 'Psicólogo', 'laura.perez@utmedic.com', '4431234567', 13);
...
--
ALTER TABLE `motivo`
  MODIFY `idMotivo` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=20;
...
--
ALTER TABLE `personal_salud`
  ADD CONSTRAINT `personal_salud_ibfk_1` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`idUsuario`);
COMMIT;
